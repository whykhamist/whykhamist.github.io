<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    />
    <path class="st189" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      d="M6 41h60v49H6zm.6-34.6h3.3v11.4h4.3v2.9H6.6V6.4zm10.3 0h3.3v14.3h-3.3V6.4zm9.2 2.9H23V6.4h9.6v2.9h-3.2v11.4h-3.3V9.3z"
      fill="#fff"
    />
    <path
      id="path1236"
