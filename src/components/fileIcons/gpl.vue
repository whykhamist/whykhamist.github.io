<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    />
    <path class="st138" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
    ...
    <path
      class="st138"
      d="M29.7 83.4c-.1 0-.2 0-.3-.1-7.2-2.7-12-9.7-12-17.3 0-10.2 8.3-18.5 18.5-18.5S54.4 55.8 54.4 66c0 7.6-4.8 14.6-12 17.3-.2.1-.4.1-.6 0-.2-.1-.3-.2-.4-.4l-4-10.5c-.2-.4.1-.9.5-1 2.2-.8 3.6-2.9 3.6-5.3 0-3.1-2.5-5.6-5.6-5.6s-5.6 2.5-5.6 5.6c0 2.3 1.5 4.4 3.6 5.3.4.2.6.6.5 1l-4 10.5c-.1.2-.2.4-.4.4 0 .1-.1.1-.3.1z"
      id="surface1"
    />
  </svg>
</template>
