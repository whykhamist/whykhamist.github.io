<template>
  <svg id="Layer_aif" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    <path
      class="st12"
      d="M0 2v92c0 1.1.9 2 2 2h68c1.1 0 2-.9 2-2V28H50c-1.1 0-2-.9-2-2V0H2C.9 0 0 .9 0 2z"
    />
    <path class="st12" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      d="M6 41h60v49H6zM9 6.4h3.6l3.6 14.3h-3.3l-.6-3h-3l-.6 3H5.4L9 6.4zm2.8 8.6l-.6-2.8c-.2-.9-.4-2.5-.4-2.5h-.1s-.2 1.5-.4 2.5L9.8 15h2zm6.9-8.6H22v14.3h-3.3V6.4zm7 0h7.1v2.9H29v3.1h3.1v2.9H29v5.4h-3.3V6.4z"
      fill="#fff"
    />
    <path
      class="st12"
