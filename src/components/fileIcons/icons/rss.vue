<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    />
    <path class="st303" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
    ...
    <path
      id="RSS"
      class="st303"
      d="M27.4 75.2c.9.9 1.4 2.1 1.4 3.4 0 1.3-.5 2.5-1.4 3.4-.9.9-2.1 1.4-3.4 1.4-1.3 0-2.5-.5-3.4-1.4-.9-.9-1.4-2-1.4-3.4 0-1.3.5-2.5 1.4-3.4.9-.9 2.1-1.4 3.4-1.4 1.4 0 2.5.6 3.4 1.4zm0 0zM20.7 82zm-1.4-22.4v6.9c4.5 0 8.7 1.8 11.9 4.9 3.2 3.2 4.9 7.4 4.9 11.9H43c0-6.5-2.7-12.5-7-16.8-4.3-4.2-10.2-6.9-16.7-6.9zm0-12.2v6.9c16 0 29.1 13.1 29.1 29.1h6.9c0-9.9-4-18.9-10.6-25.4-6.5-6.6-15.5-10.6-25.4-10.6z"
    />
  </svg>
</template>
