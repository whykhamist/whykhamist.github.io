<template>
  <svg id="Layer_3gp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    <path
      class="st2"
      d="M0 2v92c0 1.1.9 2 2 2h68c1.1 0 2-.9 2-2V28H50c-1.1 0-2-.9-2-2V0H2C.9 0 0 .9 0 2z"
    />
    <path class="st2" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      d="M6 41h60v49H6zm1.5-24c.4.4 1.1.7 1.7.7.9 0 1.6-.4 1.6-1.6 0-1-.7-1.5-2.3-1.5h-.9L7 12.8l2-2.5c.5-.6.9-1 .9-1s-.4.1-1.1.1H6.5v-3h7.2V9l-2.6 3.1c2 .5 3.1 2.1 3.1 4.1 0 2.4-1.4 4.8-4.7 4.8-1.3 0-2.5-.4-3.5-1.3L7.5 17zM23.1 6.1c1.4 0 2.9.4 3.9 1.3l-1.4 2.8c-.6-.6-1.4-.9-2.3-.9-2.2 0-3.2 1.9-3.2 4.2 0 2.6 1.2 4.3 2.9 4.3.6 0 1.3-.2 1.7-.6v-1.7h-1.5v-2.9h4.3v8.1h-2.6v-.9c-.5.7-1.6 1.2-2.7 1.2-2.8 0-5.6-2.7-5.6-7.3.2-4.5 2.7-7.6 6.5-7.6zm7.9.3h4.5c2.6 0 4.4 2 4.4 4.9 0 2.9-1.7 5-4.4 5h-1.2v4.4H31V6.4zm3.9 7c1 0 1.6-.9 1.6-2.1s-.7-2-1.6-2h-.7v4.1h.7z"
      fill="#fff"
    />
    <path
      class="st2"
