<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    />
    <path class="st155" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      d="M6 41h60v49H6zm.6-34.6h3.3v14.3H6.6V6.4zm7 0h7.1v2.9h-3.8v3.1H20v2.9h-3.1v5.4h-3.3V6.4zm10 0h7.1v2.9h-3.8v3.1H30v2.9h-3.1v5.4h-3.3V6.4z"
      fill="#fff"
    />
    <path
      class="st155"
