<template>
  <svg id="Layer_7z" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    <path
      class="st3"
      d="M0 2v92c0 1.1.9 2 2 2h68c1.1 0 2-.9 2-2V28H50c-1.1 0-2-.9-2-2V0H2C.9 0 0 .9 0 2z"
    />
    <path class="st3" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      d="M6 41h60v49H6zm4.3-30.3c.4-1 .6-1.4.6-1.4H6.1V6.4h8.2v2.4L9.7 20.7H6.3l4-10zm6.3 7.8l4.2-7.9c.5-.9.8-1.3.8-1.3s-.3.1-.8.1h-4v-3h8.7v2.2l-4.2 8c-.5.9-.8 1.3-.8 1.3s.3-.1.8-.1h4.3v2.9h-8.9v-2.2z"
      fill="#fff"
    />
    <path
      class="st3"
