<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    />
    <path
      d="M52.5 72.3S58.4 59 40.3 47c0 0 7.4 9.1 3.6 19.4 0 0-13.3-9.2-20-15.9 0 0 8.4 11.8 11.4 14.2 0 0-5-2.5-16.5-12.2 0 0 13.3 17 19.5 20.5 0 0-9.5 6.3-23.3-2.6 0 0 7.3 12.6 22.6 12.6 6.9 0 8.9-3.5 12.3-3.5 3.5 0 5.7 3.5 5.7 3.5 2-5-3.1-10.7-3.1-10.7z"
      fill="#fa2a22"
    />
  </svg>
</template>
