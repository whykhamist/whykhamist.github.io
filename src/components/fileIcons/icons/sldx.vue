<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    <path
      class="st477"
      d="M27.6 63.9h2.8v5.6h-2.8v-5.6zm4.7-1.8h2.8v7.4h-2.8v-7.4zm4.6-1.9h2.8v9.3h-2.8v-9.3zm4.6-1.8h2.8v11.1h-2.8V58.4zm-.2-4.1L36.4 57l-3.6-1.2-6.1 3.3.9 1 5.4-2.8 3.6 1.2 5.6-3.1.9 1 2.1-3.5-4.8.3.9 1.1z"
    />
  </svg>
</template>
