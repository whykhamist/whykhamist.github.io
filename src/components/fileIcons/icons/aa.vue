<template>
  <svg id="Layer_aa" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    <path
      class="st4"
      d="M0 2v92c0 1.1.9 2 2 2h68c1.1 0 2-.9 2-2V28H50c-1.1 0-2-.9-2-2V0H2C.9 0 0 .9 0 2z"
    />
    <path class="st4" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      d="M6 41h60v49H6zM9 6.4h3.6l3.6 14.3h-3.3l-.6-3h-3l-.6 3H5.4L9 6.4zm2.8 8.6l-.6-2.8c-.2-.9-.4-2.5-.4-2.5h-.1s-.2 1.5-.4 2.5L9.8 15h2zm9.3-8.6h3.6l3.6 14.3H25l-.6-3h-3l-.6 3h-3.3l3.6-14.3zm2.8 8.6l-.6-2.8c-.1-1-.3-2.5-.3-2.5h-.1s-.2 1.5-.4 2.5l-.6 2.8h2z"
      fill="#fff"
    />
    <path
      class="st4"
