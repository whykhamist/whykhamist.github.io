<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    <path
      fill="#999"
      d="M24.6 54c5.6 0 8.3 3.1 8.3 3.1l-2.5 5.4s-2.2-2.2-5.3-2.2c-3.8 0-5.6 2.6-5.6 5.6 0 3 1.9 5.8 5.6 5.8 3.5 0 5.5-2.7 5.5-2.7l3 5.2s-2.9 3.7-8.9 3.7c-7.1 0-11.8-5-11.8-11.9-.1-6.8 4.7-12 11.7-12zm10.8 10.3h4v-4.5h3.3v4.5h4v3.4h-4v4.5h-3.3v-4.5h-4v-3.4zm12.7 0h4v-4.5h3.3v4.5h4v3.4h-4v4.5H52v-4.5h-4l.1-3.4z"
    />
  </svg>
</template>
