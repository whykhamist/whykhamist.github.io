<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    ...
    />
    <path class="st83" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
    ...
    <path
      class="st83"
      d="M59.3 26.3l4 .5-.6 6.1 3.6-.4-7 14.2-4.1-15.5 3.5 1.2.6-6.1z"
      transform="matrix(-1.52199 1.52234 -1.40668 -1.40636 178.231 24.105)"
    />
  </svg>
</template>
