<template>
  <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 96">
    <path class="st266" d="M71.9 24c-.1-.4-.2-.7-.4-1L52 1.2V24h19.9z" />
    <path
      class="st266"
    ...
    />
    <path
      d="M55.4 32.3H16.6c-1.5 0-2.6 1.2-2.6 2.6v26.9c0 1.5 1.2 2.6 2.6 2.6h38.7c1.5 0 2.6-1.2 2.6-2.6V35c.2-1.5-1-2.7-2.5-2.7z"
      fill="#ced2d8"
    />
